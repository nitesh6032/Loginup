      ...
      <div>
                ...
                <ul className="navbar-nav ml-lg-auto">
                  <li id="menu-item-22" className="menu-item menu-item-type-post_type menu-item-object-page current-menu-ancestor current-menu-parent current_page_parent current_page_ancestor menu-item-has-children menu-item-21 nav-item dropdown">
                    ...
                    <div className="sub-menu dropdown-menu" aria-labelledby="navbar-dropdown-menu-link-21">
                      ...
                      <a href="blankpage.html" className="dropdown-item nav-link" id="menu-item-39">Class 11-12</a>
                      <a href="blankpage.html" className="dropdown-item nav-link" id="menu-item-40">Programming</a>
                      <a href="blankpage.html" className="dropdown-item nav-link" id="menu-item-41">Artificial Intelligence</a>
                    </div>
                  </li>
                  {/* <li id="menu-item-23"
							...
							<div class="sub-menu dropdown-menu" aria-labelledby="navbar-dropdown-menu-link-21">
								...
								<a href="blankpage.html" class="dropdown-item nav-link" id="menu-item-36">Text Book Solutions</a>
								<a href="blankpage.html" class="dropdown-item nav-link" id="menu-item-42">Sample Papers Solutions</a>
								<a href="blankpage.html" class="dropdown-item nav-link" id="menu-item-43">Short Video Lectures</a>
								<a href="blankpage.html" class="dropdown-item nav-link" id="menu-item-44">Practice Quiz</a>
								<a href="blankpage.html" class="dropdown-item nav-link" id="menu-item-45">Youtube</a>
								<a href="blankpage.html" class="dropdown-item nav-link" id="menu-item-46">Kid Creatives</a>
                  ...
                  <li id="menu-item-21" className="menu-item menu-item-type-post_type menu-item-object-page current-menu-ancestor current-menu-parent current_page_parent current_page_ancestor menu-item-has-children menu-item-21 nav-item dropdown">
                    ...
                    <div className="sub-menu dropdown-menu" aria-labelledby="navbar-dropdown-menu-link-21" style={{padding: '0px 10px'}}>
                      <a href="blankpage.html" className="dropdown-item nav-link " id="menu-item-11">Blogs</a>
                      {/* <a href="blankpage.html" class="dropdown-item nav-link" id="menu-item-30">Latest Updates</a> */}
        ...
        <div id="login-container">
          ...
          <div id="form">
            ...
            <button onclick="signin()" id="signup">Sign In</button>
            <br />
            <p style={{color: 'white', float: 'right', marginBottom: '20px'}}>New to 3-GB? <span className="span-text"><a href="signUp.html">Sign Up</a></span></p>
          </div>
        </div>
        {/* footer */}
